      ...
      ${sticky?"sticky-navbar shadow-md bg-base-200 duration-300 transition-all ease-in-out":""}`}>
        <div className="navbar">
          <div className="navbar-start">
            ...
            <a className="text-2xl font-bold select-none cursor-pointer">
              Book Store
            </a>
          </div>
          <div className="navbar-end space-x-5">
            ...
            <div className="searchbar hidden md:block">
              <label className="px-3 py-2 border-md rounded flex items-center gap-2">
            ...
            <div className="loginbtn">
              <a className="bg-blue-800 text-white px-7 py-3 rounded-md cursor-pointer font-semibold">
                Login
              </a>
            </div>
          </div>
